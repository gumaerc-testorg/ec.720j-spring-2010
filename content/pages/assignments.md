...
The goal of the Mini Project is to design an affordable rainwater harvesting system that is made up of several small storage units that can be fit with attachments for drinking, cooking, hand washing and irrigation (and possibly other applications too). We will have a chance to experiment with some of the technologies that may influence the design ({{% resource_link "4da3dc65-01b7-4553-98a3-6ad978c81660" "SODIS water bags" %}}, {{% resource_link "87e1757f-ae52-4a43-adba-adcb26ed49e9" "tippy tap hand washers" %}} and {{% resource_link "a4037845-f91c-40de-bf08-335cd7418a77" "IDE drip irrigation kits" %}}) in class Ses #4.
